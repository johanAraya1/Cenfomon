...
import { Panantel } from "../productoConcreto/Panantel";
var FabricaPanantel = (function () {
    function FabricaPanantel() {
    }
    FabricaPanantel.prototype.crearCenfomon = function () {
        var gestorMov = new GestorMovimiento();
        var gestorTipoElem = new GestorTipoElemento();
        var especie = new Especie();
        var tiposmov = ["fuego", "agua", "planta", "electrico"];
        especie.tipoElemento.push(gestorTipoElem.crearTipoElemento("electrico"), gestorTipoElem.crearTipoElemento("volador"));
        var cenfomon = new Panantel();
    ...
    return FabricaPanantel;
}());
export { FabricaPanantel };
//# sourceMappingURL=FabricaPanantel.js.map