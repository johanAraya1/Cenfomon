...
var GestorCenfomon = (function () {
    function GestorCenfomon() {
    }
    GestorCenfomon.prototype.crearCenfomon = function (nombre) {
        switch (nombre) {
            case "osotias":
    ...
    return GestorCenfomon;
}());
export { GestorCenfomon };
//# sourceMappingURL=GestorCenfomon.js.map