...
var ElectricoBajo = (function (_super) {
    __extends(ElectricoBajo, _super);
    function ElectricoBajo() {
        var _this = _super.call(this) || this;
        _this.listaNombres = ["Bola eléctrica", "Campo eléctrico", "Carga", "Carga parábola", "Chispa", "Chispazo", "Colmillo rayo"];
    ...
    return ElectricoBajo;
}(Movimiento));
export { ElectricoBajo };
//# sourceMappingURL=ElectricoBajo.js.map