...
var FabricaMovimiento = (function () {
    function FabricaMovimiento() {
    }
    FabricaMovimiento.prototype.crearMovimiento = function (tipo, puntos) {
        switch (tipo) {
            case "fuego":
                if (puntos == 10) {
    ...
    return FabricaMovimiento;
}());
export { FabricaMovimiento };
//# sourceMappingURL=FabricaMovimiento.js.map